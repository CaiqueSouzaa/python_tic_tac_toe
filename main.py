def getValue():
    ...
    try:
        ...
        print(
            "Invalid value for coordinate Y. Please, try again or type '69' for exit of game."
        )
        try:
            if coord_y == 69:
                game(0, 1)
...
def logic(matriz):
    if (
        ...
        and matriz[0][1] == "X"
        and matriz[0][2] == "X"
        or matriz[1][0] == "X"  # HORIZONTAL
        and matriz[1][1] == "X"
        and matriz[1][2] == "X"
        or matriz[2][0] == "X"  # HORIZONTAL
        and matriz[2][1] == "X"
        and matriz[2][2] == "X"
        or matriz[0][0] == "X"  # HORIZONTAL
        and matriz[1][0] == "X"
        and matriz[2][0] == "X"
        or matriz[0][1] == "X"  # VERTICAL
        and matriz[1][1] == "X"
        and matriz[2][1] == "X"
        or matriz[0][2] == "X"  # VERTICAL
        and matriz[1][2] == "X"
        and matriz[2][2] == "X"
        or matriz[0][0] == "X"  # VERTICAL
        and matriz[1][1] == "X"
        and matriz[2][2] == "X"
        or matriz[0][2] == "X"
        and matriz[1][1] == "X"
        ...
        and matriz[0][1] == "O"
        and matriz[0][2] == "O"
        or matriz[1][0] == "O"  # HORIZONTAL
        and matriz[1][1] == "O"
        and matriz[1][2] == "O"
        or matriz[2][0] == "O"  # HORIZONTAL
        and matriz[2][1] == "O"
        and matriz[2][2] == "O"
        or matriz[0][0] == "O"  # HORIZONTAL
        and matriz[1][0] == "O"
        and matriz[2][0] == "O"
        or matriz[0][1] == "O"  # VERTICAL
        and matriz[1][1] == "O"
        and matriz[2][1] == "O"
        or matriz[0][2] == "O"  # VERTICAL
        and matriz[1][2] == "O"
        and matriz[2][2] == "O"
        or matriz[0][0] == "O"  # VERTICAL
        and matriz[1][1] == "O"
        and matriz[2][2] == "O"
        or matriz[0][2] == "O"
        and matriz[1][1] == "O"
